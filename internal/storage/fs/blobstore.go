...
func (fs *FileSystemStorage) LoadBlob(uid, blobid string) (reader io.ReadCloser, size int64, err error) {
	...
	return reader, fi.Size(), err
}

// StoreBlob stores a document
func (fs *FileSystemStorage) StoreBlob(uid, id string, reader io.Reader) (err error) {
