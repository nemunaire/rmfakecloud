...
// BlobExists checks if a blob exists in the storage backend
func (bs *BlobStorer) BlobExists(uid, blobID string) (bool, error) {
	return bs.impl.BlobExists(uid, blobID)
}
