...
type BlobStorage interface {
	...
	StoreBlob(uid, blobID string, s io.Reader) error
	LoadBlob(uid, blobID string) (reader io.ReadCloser, size int64, err error)
...
type UserStorer interface {
	...
	UpdateRootIndex(uid string, stream io.Reader, lastGen int64) (int64, error)
}
